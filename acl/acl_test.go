...
func (m *mock) GetListener(controller uint32) (netip.AddrPort, uint8, error) {
	return netip.AddrPort{}, 0, nil
}

func (m *mock) SetListener(controller uint32, address netip.AddrPort, interval uint8) (bool, error) {
	return false, nil
}
