...
func TestParseTSVWithMultipleDevices(t *testing.T) {
	expected := map[uint32][]types.Card{
		...
		54321: []types.Card{
			types.Card{CardNumber: 65537, From: types.MustParseDate("2020-01-02"), To: types.MustParseDate("2020-10-31"), Doors: map[uint8]uint8{1: 1, 2: 1, 3: 0, 4: 1}},
			types.Card{CardNumber: 65538, From: types.MustParseDate("2020-02-03"), To: types.MustParseDate("2020-11-30"), Doors: map[uint8]uint8{1: 1, 2: 0, 3: 1, 4: 1}},
			types.Card{CardNumber: 65539, From: types.MustParseDate("2020-03-04"), To: types.MustParseDate("2020-12-31"), Doors: map[uint8]uint8{1: 0, 2: 1, 3: 1, 4: 1}},
		},
	}
...
func TestMakeTSVWithPIN(t *testing.T) {
	acl := ACL{
		12345: map[uint32]types.Card{
			65536: types.Card{CardNumber: 65536, From: types.MustParseDate("2023-01-01"), To: types.MustParseDate("2023-12-31"), Doors: map[uint8]uint8{1: 1, 2: 0, 3: 1, 4: 0}, PIN: 7531},
			65537: types.Card{CardNumber: 65537, From: types.MustParseDate("2023-01-02"), To: types.MustParseDate("2023-10-31"), Doors: map[uint8]uint8{1: 1, 2: 0, 3: 0, 4: 0}, PIN: 0},
			65538: types.Card{CardNumber: 65538, From: types.MustParseDate("2023-02-03"), To: types.MustParseDate("2023-11-30"), Doors: map[uint8]uint8{1: 1, 2: 0, 3: 0, 4: 1}, PIN: 1357},
			65539: types.Card{CardNumber: 65539, From: types.MustParseDate("2023-03-04"), To: types.MustParseDate("2023-12-31"), Doors: map[uint8]uint8{1: 0, 2: 0, 3: 0, 4: 0}, PIN: 0},
		},
		54321: map[uint32]types.Card{
			65537: types.Card{CardNumber: 65537, From: types.MustParseDate("2023-01-01"), To: types.MustParseDate("2023-12-31"), Doors: map[uint8]uint8{1: 1, 2: 1, 3: 0, 4: 1}, PIN: 0},
			65538: types.Card{CardNumber: 65538, From: types.MustParseDate("2023-03-01"), To: types.MustParseDate("2023-10-31"), Doors: map[uint8]uint8{1: 1, 2: 0, 3: 1, 4: 1}, PIN: 1357},
			65539: types.Card{CardNumber: 65539, From: types.MustParseDate("2023-01-03"), To: types.MustParseDate("2023-11-30"), Doors: map[uint8]uint8{1: 0, 2: 1, 3: 1, 4: 1}, PIN: 0},
			65540: types.Card{CardNumber: 65540, From: types.MustParseDate("2019-01-01"), To: types.MustParseDate("2025-12-31"), Doors: map[uint8]uint8{1: 0, 2: 1, 3: 0, 4: 1}, PIN: 2468},
		},
	}
...
func TestMakeTSVWithInconsistentPINs(t *testing.T) {
	acl := ACL{
		12345: map[uint32]types.Card{
			...
			65537: types.Card{CardNumber: 65537, From: types.MustParseDate("2023-01-02"), To: types.MustParseDate("2023-10-31"), Doors: map[uint8]uint8{1: 1, 2: 0, 3: 0, 4: 0}, PIN: 0},
			65538: types.Card{CardNumber: 65538, From: types.MustParseDate("2023-02-03"), To: types.MustParseDate("2023-11-30"), Doors: map[uint8]uint8{1: 1, 2: 0, 3: 0, 4: 1}, PIN: 1357},
			65539: types.Card{CardNumber: 65539, From: types.MustParseDate("2023-03-04"), To: types.MustParseDate("2023-12-31"), Doors: map[uint8]uint8{1: 0, 2: 0, 3: 0, 4: 0}, PIN: 8642},
		},
		54321: map[uint32]types.Card{
			65537: types.Card{CardNumber: 65537, From: types.MustParseDate("2023-01-01"), To: types.MustParseDate("2023-12-31"), Doors: map[uint8]uint8{1: 1, 2: 1, 3: 0, 4: 1}, PIN: 9753},
			65538: types.Card{CardNumber: 65538, From: types.MustParseDate("2023-03-01"), To: types.MustParseDate("2023-10-31"), Doors: map[uint8]uint8{1: 1, 2: 0, 3: 1, 4: 1}, PIN: 1357},
			65539: types.Card{CardNumber: 65539, From: types.MustParseDate("2023-01-03"), To: types.MustParseDate("2023-11-30"), Doors: map[uint8]uint8{1: 0, 2: 1, 3: 1, 4: 1}, PIN: 0},
			65540: types.Card{CardNumber: 65540, From: types.MustParseDate("2019-01-01"), To: types.MustParseDate("2025-12-31"), Doors: map[uint8]uint8{1: 0, 2: 1, 3: 0, 4: 1}, PIN: 2468},
		},
